          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-7">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div>
                  <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2" style={SERIF}>
                    {listing.title}
                  </h1>
                ...
                <div className="text-right">
                  <p className="text-3xl font-bold text-amber-600" style={SANS}>
                    Ksh {listing.price.toLocaleString()}
                  </p>
                  {isRent && (
                    <p className="text-sm text-gray-400 mt-0.5" style={SANS}>per month</p>
                  )}
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div
                    key={stat.label}
                    className="flex flex-col items-center p-4 bg-gray-50 rounded-xl border border-gray-100"
                  >
            ...
            {listing.description && (
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-7">
                <h2 className="font-bold text-lg text-gray-900 mb-4" style={SERIF}>
                  About This Property
                </h2>
                <p className="text-gray-600 leading-relaxed whitespace-pre-line" style={SANS}>
                  {listing.description}
                </p>
              </div>
            )}
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-7">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={feature} className="flex items-center gap-2 text-sm text-gray-600" style={SANS}>
          ...
          <aside className="space-y-4">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
              ...
              <div className="flex items-center gap-3 mb-5 pb-5 border-b border-gray-100">
                ...
                <div>
                  <p className="font-semibold text-gray-900" style={SERIF}>
                    {listing.agentName ?? "Listed Agent"}
                  </p>
                  <p className="text-xs text-gray-400 mt-0.5" style={SANS}>Verified Agent · FindAHome</p>
                </div>
              </div>

              <h3 className="text-base font-bold text-gray-900 mb-4" style={SERIF}>
              ...
              <div className="space-y-3">
                ...
                {!listing.agentPhone && !listing.agentEmail && (
                  <p className="text-sm text-gray-400 text-center py-2" style={SANS}>
